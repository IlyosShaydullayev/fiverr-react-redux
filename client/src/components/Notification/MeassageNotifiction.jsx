...
function MeassageNotifiction() {
  ...
  useEffect(() => {
    const handleClickOutside = (e) => {
      if (e.target.id !== "messageNotification") {
        setIsOpen(false);
      } else {
        setIsOpen(true);
      }
    ...
    <div>
      ...
      >
        <span id="messageNotification" className="relative inline-block mt-1">
          <MailOutline fontSize="medium" id="messageNotification" />
      ...
      {isOpen && (
        ...
        >
          <div
            ...
            aria-label="messageNotificationButton"
          >
            <div
                ...
                <div className="flex flex-col items-center bg-white h-full justify-center leading-5 text-center">
                  <strong className="contents text-[17px] font-normal pb-[10px]">
                    <span className="p-2 grid justify-center rounded-full bg-zinc-100">
                      <NotificationsOffTwoToneIcon fontSize="large" className="opacity-20"/>
                    </span>
                  </strong>
...
export default MeassageNotifiction;
